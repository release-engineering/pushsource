...
- Support for "alias signing key" in `ErrataSource` and `KojiSource`
...
- Dropped `importlib` as it's not needed for getting `attr` module version.
...
[Unreleased]: https://github.com/release-engineering/pushsource/compare/v2.52.0...HEAD
